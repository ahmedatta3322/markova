...
/* 
 <Content>
        <animated.img
          ...
          style={props}
        ></animated.img>
        <animated.h1 className="servicetitle" style={boxprops1}>
          Digital Marketing
        </animated.h1>
        <animated.h1 class="servicetitle" style={boxprops2}>
          Media buying
        </animated.h1>
        <animated.h1 id="serviceone" class="servicetitle" style={boxprops3}>
          Email Marketing
        </animated.h1>
        <animated.h1 id="servicetow" class="servicetitle" style={boxprops4}>
          Social media marketing
        </animated.h1>
        <animated.h1 id="servicetow" class="servicetitle" style={boxprops5}>
          Google adword
        </animated.h1>
        <animated.img
          className="whitepart"
